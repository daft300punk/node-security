      ...
      <div className="timeline-event_details">
        ...
        <div className="timeline-event_details-text">
          ...
          <section>
            ...
            <p>
              Cast your vote for most infamous hacker or catastrophic data branch while there's still time.
              Voting event's will change periodically so check back often. Don't forget to check the
